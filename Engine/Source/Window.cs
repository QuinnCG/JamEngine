...
public static unsafe class Window
{
	...
	/// <summary>
	/// Has the window been closed in some way; e.g. pressing the x button on the top-right.<br/>
	/// This doesn't mean the window is actually closed, just that it should be and likely will be soon.
	/// </summary>
